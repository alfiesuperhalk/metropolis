                  ...
                  <Table className="v-middle no-wrap" responsive>
                    ...
                    <tbody>
                      ...
                      <tr className="table-danger">
                        ...
                        <td>
                          <i className="cc XRP mr-1"></i>{" "}
                          <span className="font-medium">1.123</span>
                        </td>
                        <td>12:43:09</td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <i className="cc ETH mr-1 blue-text"></i>{" "}
                          <span className="font-medium">0.123</span>
                        </td>
                        <td>12:45:09</td>
                      </tr>
                      <tr>
                        <td>
                          <span className="text-danger">$12948.89</span>
                        </td>
                        <td>
                          <i className="cc BTC mr-1"></i>{" "}
                          <span className="font-medium">0.123</span>
                      ...
                      <tr className="table-success">
                        <td>
                          <span className="text-success">$23135.78</span>
                        </td>
                        <td>
                          <i className="cc XRP mr-1"></i>{" "}
                          <span className="font-medium">1.123</span>
