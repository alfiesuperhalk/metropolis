            ...
            <Table className="v-middle">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <i
                      className="fa fa-circle text-orange"
                      id="TooltipExample11"
                    ></i>
                    <Tooltip
                      placement="top"
                ...
                <tr>
                  <td>
                    <div className="d-flex align-items-center">
                      ...
                      <div className="">
                        <h5 className="mb-0 font-16 font-medium">Red Sandle</h5>
                      </div>
                    </div>
                  </td>
                  <td>Dummy Product</td>
